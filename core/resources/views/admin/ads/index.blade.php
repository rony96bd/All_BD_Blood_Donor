...
@section('panel')
                                    ...
                                    <tr>
                                        <td data-label="@lang('Name')">
                                            @if ($advr->type == 1)
                                                <div class="user">
                                                    <div class="thumb">
                                                        <a href="{{ getImage(imagePath()['advertisement']['path'] . '/' . $advr->image, $advr->size) }}"
                                                            target="__blank">
                                                            <img src="{{ getImage(imagePath()['advertisement']['path'] . '/' . $advr->image, $advr->size) }}"
                                                                alt="@lang('image')">
                                                        </a>
                                                    </div>
                                        ...
                                        <td data-label="@lang('Advertisement Type')">
                                            @if ($advr->type == 1)
                                                <span
                                                    class="font-weight-normal badge badge--success">@lang('Banner')</span>
                                            @else
                                                <span
                                                    class="font-weight-normal badge badge--primary">@lang('Script')</span>
                                            @endif
                                        </td>
                                        ...
                                        <td data-label="Action">
                                            <a href="{{ route('admin.ads.edit', $advr->id) }}" class="icon-btn mr-2 edit"
                                                data-toggle="tooltip" title="@lang('Edit')">
                                                <i class="las la-pen text--shadow"></i>
                                            </a>
                                            <a href="javascript:void(0)" data-id="{{ $advr->id }}"
                                                class="icon-btn btn--danger delete" data-toggle="tooltip"
                                                title="@lang('Delete')"><i class="las la-trash text--shadow"></i>
                                            </a>
                                        </td>
                                    </tr>
                                @empty
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="bannerAdd">
                            <div class="form-group ru">
                                ...
                                <input type="text" class="form-control form-control-lg" name="redirect_url"
                                    placeholder="@lang('http/https://example.com')" value="{{ old('redirect_url') }}"
                                    id="redirect_url">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn--primary"><i
                                class="fa fa-fw fa-paper-plane"></i>@lang('Save')</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="deleteAds" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
