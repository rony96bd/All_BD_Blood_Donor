                                        ...
                                        <form action="{{ route('donor.profile.update') }}" id="basic-form" method="POST"
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="avatar-upload">
                                                            <div class="avatar-edit">
                                                                <input type='file' id="imageUpload"
                                                                    ...
                                                                    class="imageUpload" required="" />
                                                                <input type="hidden" name="base64image" required=""
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        <label
                                                            class="form-control-label font-weight-bold">@lang('Name')</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="gender"
                                                            class="font-weight-bold">@lang('Gender')</label>
                                                        <select name="gender" id="gender"
                                                            class="form-control form-control" required="">
                                                            <option value="" selected="" disabled="">
                                                                @lang('Select One')</option>
                                                            <option value="1"
                                                                @if ($donor->gender == 1) selected @endif>
                                                                @lang('Male')</option>
                                                            <option value="2"
                                                    ...
                                                    <div class="form-group">
                                                        <label for="religion"
                                                            class="font-weight-bold">@lang('Religion')</label>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="email"
                                                            class="font-weight-bold">@lang('Email')</label>
                                                        <input type="email" name="email" id="email"
                                                            value="{{ __($donor->email) }}"
                                                            placeholder="@lang('Enter Email')" class="form-control"
                                                            maxlength="60">
                                                    </div>
                                                    <label for="facebook"
                                                    ...
                                                    <div class="form-group ">
                                                        <label
                                                            class="form-control-label font-weight-bold">@lang('Secondary Phone')</label>
