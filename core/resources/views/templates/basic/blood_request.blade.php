                            ...
                            <div class="col-lg-6">
                                <div class="card swiper-slide bnfont">
                                        ...
                                        <div class="container">
                                            <a class="link-dark"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class=""
                                                        style="padding-left: 0px; line-height: 20px; width: 75%">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <span style="text-align: center; width: 100%; padding-top: 12px;"><a href="{{ route('bloodrequest.details',[$bloodRequest->id]) }}"
                                                class="button">View
                                                Details</a></span>
                                    </div>
                                </div>
