...
<section class="pt-100 pb-100 border-top  position-relative z-index-2 overflow-hidden">
    <div class="bottom-el-bg">
        <img src="{{ getImage('assets/images/frontend/featured_donor/' . @$donor->data_values->background_image, '1920x596') }}"
            alt="@lang('image')">
    </div>
            ...
            @foreach ($donors as $donor)
                <div class="single-slide">
                    <div class="donor-card has--link">
                        <a href="{{ route('donor.details', [slug($donor->name), encrypt($donor->id)]) }}"
                            class="item--link"></a>
                        ...
                        <div class="donor-card__content">
                            ...
                            <span class="donor-card__amount mt-1"><i class="las la-tint"></i>
                                {{ __($donor->total_donate) }} @lang('Times')</span>
                        </div>
                    </div>
                </div>
            @endforeach
